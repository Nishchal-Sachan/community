const INITIATIVES = [
  {
    ...
    description:
      "Supporting skill-building workshops and mentorship initiatives.",
    icon: (
  ...
  },
  {
    ...
    description:
      "Promoting entrepreneurship and financial literacy programs.",
    icon: (
      <svg className="h-10 w-10" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    ...
    description:
      "Roads, sanitation, and public facilities upgrades.",
    icon: (
      <svg className="h-10 w-10" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    ...
    description:
      "Free medical camps and wellness awareness campaigns.",
    icon: (
      <svg className="h-10 w-10" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-4 lg:gap-8">
          {INITIATIVES.map((item) => (
            <div
              key={item.title}
              className="flex flex-col rounded-xl border border-slate-200 bg-white p-6 shadow-sm transition hover:shadow-md sm:p-8"
            >
              <div className="flex h-14 w-14 items-center justify-center rounded-xl bg-slate-900 text-white">
                {item.icon}
              </div>
              <h3 className="mt-5 text-base font-semibold text-slate-900 sm:mt-6 sm:text-lg">{item.title}</h3>
